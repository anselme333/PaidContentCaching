...
#include "../../../build/ns3/ndnSIM/NFD/common.hpp"
#include "../../../build/ns3/ndnSIM/utils/ndn-rtt-estimator.hpp"
...
/****************************************************************************/
  ...
  thisNode = ns3::NodeList::GetNode(ns3:: Simulator::GetContext());//get the node-id
  Name dataName(m_interestName);
  std::string NodeName=std::to_string(thisNode);// convert to string
  dataName.append(NodeName);//Append it to the existing prefix name
