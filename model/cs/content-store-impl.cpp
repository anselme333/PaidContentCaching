...
#include "../../utils/trie/price_based_policy.hpp" // Policy added by Anselme
...
/**
 * @brief ContentStore with price based replacement policy
 **/
template class ContentStoreImpl<price_based_traits>;
...
NS_OBJECT_ENSURE_REGISTERED_TEMPL(ContentStoreImpl, price_based_traits);
...
typedef multi_policy_traits<boost::mpl::vector2<price_based_traits, aggregate_stats_policy_traits>>
		PbrWithCountsTraits;
...
template class ContentStoreImpl<PbrWithCountsTraits>;
NS_OBJECT_ENSURE_REGISTERED_TEMPL(ContentStoreImpl, PbrWithCountsTraits);
...
/**
 * \brief Content Store implementing price based replacement policy
 */
class Pbr : public ContentStoreImpl<PbrWithCountsTraits> {
};
#endif
