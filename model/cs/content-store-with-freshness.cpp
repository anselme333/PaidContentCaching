...
#include "../../utils/trie/price_based_policy.hpp" //added by anselme
...
/**
 * @brief ContentStore with freshness and Price Based Replacement policy
 **/
template class ContentStoreWithFreshness<price_based_traits>; // added by Anselme
...
NS_OBJECT_ENSURE_REGISTERED_TEMPL(ContentStoreWithFreshness, price_based_traits); // added by Anselme
...
/**
 * \brief Content Store with freshness implementing Least Price Based Replacement policy //added by Anselme
 */
class Freshness::Pbr: public ContentStoreWithFreshness<price_based_traits> {
};
