...
#include "sub-domain-strategy.hpp"
#include "core/logger.hpp"

namespace nfd {
namespace fw {

NFD_LOG_INIT("SubDomainStrategy");
const Name SubDomainStrategy::STRATEGY_NAME("ndn:/localhost/nfd/strategy/sub-domain/%FD%01");
NFD_REGISTER_STRATEGY(SubDomainStrategy);

SubDomainStrategy::SubDomainStrategy(Forwarder& forwarder, const Name& name)
...
void
SubDomainStrategy::afterReceiveInterest(const Face& inFace,
