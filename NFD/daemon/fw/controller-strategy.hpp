...
#ifndef NFD_DAEMON_CONTROLLER_STRATEGY_HPP
...
{
public:
  ControllerStrategy(Forwarder& forwarder, const Name& name = STRATEGY_NAME);
...
#endif // NFD_DAEMON_FW_MULTICAST_CONTROLLER_HPP
