...
#ifndef NFD_DAEMON_FW_SUB_DOMAIN_STRATEGY_HPP
#define NFD_DAEMON_FW_SUB_DOMAIN_STRATEGY_HPP
 ...
 */
class SubDomainStrategy : public Strategy
{
public:
	SubDomainStrategy(Forwarder& forwarder, const Name& name = STRATEGY_NAME);
