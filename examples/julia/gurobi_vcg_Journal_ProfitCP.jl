...
t=[] # CP profit array Initiliazation
z=[] # Number of customer array Initiliazation
u=[] # CP profit array Initiliazation
v=[] # ICSP profit array Initiliazation
...
# In-Network Caching CP rofits graph

fig = figure("pyplot_multiaxis",figsize=(10,10))
p =plot(z,t,color="red",marker="o", markersize=10, linewidth=2.0, label="Optimal: CP Profit")
ax = gca()
title("In-Network Caching Profits", fontsize=20)
grid("on")
xlabel("Number of customers", fontsize=20)
font1 = Dict("color"=>"red")
ylabel("Optiml CP Profit",fontdict=font1, fontsize=20)
...
p =plot(z,u,color="purple",marker="*", markersize=20, linewidth=2.0, label="VCG: CP Profit")# Plot a basic line
...
p = plot_date(z,v, color="green",linestyle="-",linewidth=2.0, marker="x",markersize=20,label="Optimal: ICSP profit") # Plot a basic line
